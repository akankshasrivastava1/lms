...
background: linear-gradient(to right, #49a09d, #5f2c82); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
  ...
  <body style="background-image: url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fhipwallpaper.com%2Felegant-web-backgrounds%2F&psig=AOvVaw0olfeVOyPXM6qGsoHolv-p&ust=1624457601358000&source=images&cd=vfe&ved=0CAoQjRxqFwoTCKCK96K2q_ECFQAAAAAdAAAAABAD');">
      ...
      <div class="row">
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark "><a href="manage_courses/manage_courses.php">Manage Placement Courses</a></li>
            <li class="list-group-item bg-dark"><a href="manage_videos/manage_videos.php">Manage Other Courses</a></li>
            <li class="list-group-item bg-dark"><a href="manage_quiz/manage_quiz.php">Manage Assessments</a></li>
        ...
        <div class=" col-md-10">
          ...
          <div class="col-md-4 mt-3 ml-5">
            <div class="card shadow " style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
              ...
              <div class="card-body">
                <p class="card-text"><a href="manage_courses/manage_courses.php" style="text-decoration: none;">MANAGE PLACEMENT COURSE <i class="fa fa-book ml-3"></i></a></p>
              </div>
            </div>
           ...
           <div class="col-md-4 mt-3">
            <div class="card shadow" style="width: 18rem;cursor:pointer; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
              ...
              <div class="card-body">
                <p class="card-text "><a href="manage_videos/manage_videos.php" style="text-decoration: none; color: orangered">MANAGE VIDEO TUTORIALS</a><i class="fa fa-video-camera ml-3" style="color: orangered"></i></p>
              </div>
            </div>
      ...
      <tr>
        <td class="mytable1">
           <div class="card shadow border-0 " style="width: 15rem; height: 110px; box-shadow: 2px 3px #827171; border-radius:0px; border-top-left-radius: 0px;">
              ...
              <div class="card-body">
                <p class="card-text text-white"><b class="h4">No. Of Placement Courses </b><br><span style="font-size: 20px;"><?php $admin->display_course_count(); ?></span></p>
              </div>
            </div>
      ...
      <tr>
        <td class="mytable2">
           <div class="card shadow border-0" style="width: 15rem; height: 110px; box-shadow: 2px 2px #827171; border-radius:0px; border-top-left-radius: 0px;">
             ...
             <div class="card-body">
                <p class="card-text text-white"><b class="h4">No. Of Video Tutorial Course</b><br><span style="font-size: 20px;"><?php $admin->display_video_count(); ?></span></p>
              </div>
           ...
           <div class="col-md-3 mt-5 ml-5">
            <div class="card shadow" style="width: 15rem; height:22rem; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
              ...
              <div class="card-body">
                <p class="card-text "><a href="manage_quiz/manage_quiz.php" style="text-decoration: none; color: orangered">MANAGE YOUR ASSESSMENTS</a></p>
              </div>
            </div>
