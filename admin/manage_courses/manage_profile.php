<?php 
include("../classes/manage_profile_class.php");
$profile=new manage_profile_class;			// creating object of  manage_profile_class.php
$profile=$profile->display_profile();    //calling display_courses() method from manage_courses_class.php
...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../admin_main.php"></a>
...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            <li class="list-group-item  bg-dark "><a href="../dashboard.php">Hey!...</a></li>
            <li class="list-group-item bg-dark "><a href="#"> Profile</a></li>
            <li class="list-group-item bg-dark"><a href="../.php">My Courses</a></li>
            <li class="list-group-item bg-dark"><a href="">Assessments</a></li>
            <li class="list-group-item bg-dark"><a href="">Leaderboard</a></li>
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#manage_course">Manage Your Profile</a>
  </li>
 <!--  <li class="nav-item">
...
<?php foreach ($profile as $profile_list)
 {
	?>
  	
  		<div class="card ml-5 mt-4" style="width: 18rem;">
  <img class="card-img-top" src="../../<?php echo $profile_list['profile_name'] ?>" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title"><?php echo $_list['profile_name']; ?> <a href=".php?profile_name=<?php echo $profile_list['profile_name']; ?>" class="h6 text-info float-right"> <i class="fa fa-pencil ml-1"></i></a></h5>
    <p class="card-text"><?php echo $profile_list['profile_email']; ?></p>
	<p class="card-text"><?php echo $profile_list['profile_contact']; ?></p>
	<p class="card-text"><?php echo $profile_list['profile_course']; ?></p>
	<p class="card-text"><?php echo $profile_list['profile_sem']; ?></p>
        ...
        <div class="tab-content" id="myTabContent">   <!-- tab content starts -->
          ...
          <div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
            ...
            <div class="card-body col-md-12">
				  ...
				  <div class="card-header bg-danger text-light p-2 cardh2"><h3>ADD YOUR DETAILS</h3></div>
				  
				  <div class="card-body small" ">

				  <form action="profile_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
					    
					     <div class="form-group">
					      <label for="pwd">Profile Image</label>
					      <input type="file" class="form-control" id="c_img" placeholder="Enter Profile Image" name="course_image">
					      <span id="image_error" class="text-danger font-weight-bold"></span>
					    </div>
						
						<div class="form-group">
					      <label for="email">Full Name :</label>
					      <input type="text" class="form-control" id="c_name" placeholder="Enter Your Full Name" name="course_name">
					      <span id="name_error" class="text-danger font-weight-bold"></span>
					    </div>
						
						<div class="form-group">
					      <label for="email">Email Address :</label>
					      <input type="text" class="form-control" id="c_name" placeholder="Enter Your email" name="course_name">
					      <span id="name_error" class="text-danger font-weight-bold"></span>
					    </div>
						
						<div class="form-group">
					      <label for="email">Contact number :</label>
					      <input type="text" class="form-control" id="c_name" placeholder="Enter Your Contact Number" name="course_name">
					      <span id="name_error" class="text-danger font-weight-bold"></span>
					    </div>
						
					    <div class="form-group">
					      <label for="pwd">Course (with enrollment no.)</label>
					      <input type="text" class="form-control" id="c_desc" placeholder="Enter Your Course Name(with enrollment no.)" name="course_desc">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>
						
						
					    <div class="form-group">
					      <label for="pwd">Current semester</label>
					      <input type="text" class="form-control" id="c_desc" placeholder="Enter Your Course Name" name="course_desc">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>
          ...
          <div class="tab-pane fade p-3" id="two" role="tabpanel" aria-labelledby="two-tab">
            ...
            <div class="card-body col-md-12">
            		...
            		<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 cardh2 "><h3>UPDATE DETAILS</h3></div>
				  
				  <div class="card-body small" >
					    
				 

				 <form action="profile_add.php" method="post" enctype="multipart/form-data" onsubmit="">
				 	 ...
				 	 <div class="form-group">
					    ...
					    <select class="form-control" id="exampleFormControlSelect1" name="selected-course-to-update">
					    	...
					    	<?php  foreach ($profile as $profile_list)
							 {
										?> 
					      <option><?php echo  $profile_list['profile_name']; ?></option>
					      <?php } ?>
					    ...
					    <div class="form-group">
					      <label for="pwd">Course & Current Semester</label>
