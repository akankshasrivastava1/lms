...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark "><a href="#">Manage Placement Courses</a></li>
            <li class="list-group-item bg-dark"><a href="../manage_quiz/manage_quiz.php">Manage Other Courses</a></li>
            <li class="list-group-item bg-dark"><a href="">Manage Assessments</a></li>
