      ...
      <div class="row">
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            <li class="list-group-item  bg-dark "><a href="">Welcome Back.....</a></li>
            <li class="list-group-item bg-dark "><a href="manage_courses/manage_profile.php">Profile</a></li>
            <li class="list-group-item bg-dark"><a href=""> My Courses</a></li>
            <li class="list-group-item bg-dark"><a href=""> Assesments</a></li>
        ...
        <div class=" col-md-10">
          ...
          <div class="col-md-4 mt-3 ml-5">
            <div class="card shadow " style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
              ...
              <div class="card-body">
                <p class="card-text"><a href="./manage_courses/manage_profile.php" style="text-decoration: none;">MANAGE YOUR Profile Here! <i class="fa fa-book ml-3"></i></a></p>
              </div>
            </div>
           ...
           <div class="col-md-4 mt-3">
            <div class="card shadow" style="width: 18rem;cursor:pointer; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
              ...
              <div class="card-body">
                <p class="card-text "><a href="manage_videos/.php" style="text-decoration: none; color: orangered">MANAGE YOUR VIDEOS</a><i class="fa fa-video-camera ml-3" style="color: orangered"></i></p>
              </div>
            </div>
