	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">LMS</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="#our-members">Certification Courses</a></li>
					<li> <a href="#myfaq">FAQs</a></li>
					<li> <a href=".\admin\dashboard.php">Your Dashboard</a></li>
         	...
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				...
         				<p>
         					 theses are the COURSES provided by us <br>
         				</p>
         			</div>
         		</div>
         	</div>
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="programmingdemo.php">CAMPUS PLACEMENT COURSES</a></h3>
         				<p>
         					Here you will find all the lecture tutorials related
							your campus drive syllabus like
							programming, cognitive skilss, verbal ability etc
         				</p>
         			</div>
         		</div>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="video tutorials\java\display_video_courses.php">VIDEO TUTORIAL COURSES</a></h3>
						<p>
         					Here you will find video tutorial on 
							courses like programming languages Courses,
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="online_quize/quizhome.php">EXERCISE AND ASSESSMENT</a></h3>   <!--  exercise/exercise.php -->
         				<p>
         					Here you will find problem programs for practice 
							and their implementation also which will improve your coding skill
         				</p>
         			</div>
         		</div>
<!-- 
 ...
 -->
			...
			<section class="work" id="work"><br>
				<h2 id="work-heading" class="text-center" style="font-weight: bold;">OUR TOP CAMPUS RECRUITING COMPANIES</h2>
				<p class="text-center">join us to improve your skills and Land your dream TECH JOB </p>
				<div class="container-fluid">
					<!---first row start-->
					<div class="row no-gutters">
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work1.png" title="">
...
-->
		...
		<section class="header7 cid-rjrjygOfd1" id="header7-3">
			...
			<div class="container text-center" id="our-members">
				<h2><b>CERTIFICATION COURSES</b></h2>
				<p>
					These are our some certification courses <br> 
				</p>
			</div>
						...
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Artificial Intelligence A-Z™: Learn How To Build An AI</h4>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Machine Learning A-Z™: Hands-On Python & R In Data Science</h4>
									<h4 class="team-member-designation"><h4>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">AWS for Beginners: The Ultimate Amazon Web Services Bootcamp</h4>
									<h4 class="team-member-designation"></h4>
									<ul class="social-list">
									</ul>
								</div>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Microsoft Azure - Beginner's Guide</h4>
									<h4 class="team-member-designation"></h4>
									<ul class="social-list">
									</ul>
								</div>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">MySQL Database Administration: Beginner SQL Database Design</h4>
									<h4 class="team-member-designation"></h4>
									<ul class="social-list">
									</ul>
								</div>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												LMS is an online E-learning website <br>
