 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
 								<h2><b>CAMPUS PLACEMENT COURSES</b></h2>
 								<div class="sub-heading">
 									Following are the upcoming CAMPUS PLACEMENT COURSES<br>
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
                <p>LMS is an excellent learning hub, dedicated to the programmer who want to explore.</p>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2021</span><span> </span><span>LMS</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>Eastern Rd of BHEL, Opp. Hataikheda Dam, Anandnagar, Bhopal, Madhya Pradesh 462021</dd>
              </dl>
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">LMS0@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
                <dd><a href="tel:#"> 0755 275 1679</a> <span>or</span> <a href="tel:#">2751679 180030005303 (Tollfree)</a>
                </dd>
              </dl>
            </div>
